...
#define configUSE_MUTEXES                   0 // LM: Disable mutexes
#define configUSE_RECURSIVE_MUTEXES         0 // LM: Disable mutexes
#define configUSE_PCP                       1 // LM: flag to enable/disable PCP functionality
